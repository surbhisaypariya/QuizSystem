...
<div class="container-fluid">
    <div class="card card-rounded ">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('subject.update',[$subject->id]) }}" class="mt-4">
                @method('PATCH')
                @csrf
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="custom-control custom-switch custom-switch-lg">
                                <input type="checkbox" class="form-check-input" id="switch2" name="status" {{ $subject->status == '1'?'checked':"" }}>
